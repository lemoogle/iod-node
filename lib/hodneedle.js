...
HODClient.prototype.post_combination = function(combination,arg1,arg2,arg3) {
  var args = parseArgs(arg1,arg2,arg3);
  var data = args.data;
  var callback = args.callback;
  var async = args.async;
  var handler = "executecombination"
...
HODClient.prototype.get = function(handler,arg1,arg2,arg3) {
  ...
  var url = util.format(this.endpoint, async_string,handler) + "?" + querystring.stringify(data)
  if (typeof callback == "undefined") {
    if (this.proxy != undefined) {
